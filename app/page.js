...
import BentoProperties from "@/components/BentoProperties/BentoProperties";
...
export default async function Home() {
  ...
  // Extraemos solo los campos necesarios para los filtros para no enviar mucha data al cliente
  ...
  return (
    <div>
      ...
      <main className="main">
        ...
        <div className="px-8 mx-auto mt-12 mb-20">
