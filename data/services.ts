...
export const servicesData: Record<string, ServiceData> = {
  ...
  tasaciones: {
    ...
    intro: "Obtén evaluaciones precisas y confiables sobre el valor real de tus propiedades. Mis servicios de tasaciones son esenciales para tomar decisiones financieras o inmobiliarias seguras, obteniendo el mejor precio posible en el mercado.",
  ...
  evaluacion: {
    ...
    intro: "Aseguro decisiones fundamentadas mediante un análisis sistemático y objetivo de tus proyectos inmobiliarios. Identifico oportunidades, evalúo riesgos y mido el impacto desde la concepción hasta la implementación.",
  ...
  asesoramiento: {
    ...
    intro: "Brindo orientación especializada a clientes que buscan realizar transacciones inmobiliarias. Abarco desde la identificación de grandes oportunidades de compra o alquiler hasta la gestión impecable de cierres exitosos.",
    image: "/assets/planos.jpg",
    secondaryImage: "/assets/papeles.jpg",
    quote: { text: "Te acompaño en cada paso legal y comercial para que tu inversión sea siempre la mejor." },
    statistics: [
    ...
    methodology: [
      { title: "Entrevista inicial", description: "Comprendo tus necesidades, presupuesto y objetivos a fondo." },
      { title: "Búsqueda y selección", description: "Filtro y visito las mejores opciones del mercado para ti." },
      { title: "Cierre exitoso", description: "Te acompaño en toda la negociación y firma de los contratos." },
    ],
    benefits: [
