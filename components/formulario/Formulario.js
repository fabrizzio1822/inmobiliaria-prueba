    ...
    return (
        <div className="formulario" id="contacto">
				<form id='formulario' action="https://formsubmit.co/inmobiliaria.lbobadilla@gmail.com" method="post" onSubmit="return validateForm()">
					...
					<input className="formulario-datos p-2" type="text" id="name" name="name" placeholder="Nombre"/><br/>
					<input className="formulario-datos p-2" type="email" id="email" name="email" placeholder="E-mail"/><br/>
					<input className="formulario-datos p-2 " type="numero" id="numero" name="numero" placeholder="Numero"/><br/>
